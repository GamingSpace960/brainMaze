...
class World():
    def __init__(self):
        ...
        wallsPos = [(0,0,500,10),(0,10,10,270),(490,10,10,270),(450,270,40,10),(30,270,340,10),(360,280,10,100),(450,280,10,100),(370,370,80,10),
        ...
        walls = [pg.draw.rect(win,(200,10,10),wall) for wall in wallsPos]
